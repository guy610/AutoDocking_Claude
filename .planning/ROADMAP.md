...
Plans:
- [x] 03-01-PLAN.md -- Services layer (USPTO client and keyword extractor)
- [x] 03-02-PLAN.md -- USPTO worker and results panel widget
- [x] 03-03-PLAN.md -- MainWindow integration and unit tests
